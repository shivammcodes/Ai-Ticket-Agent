    ...
    <div className='flex justify-between py-5 items-center fixed top-0 left-0 w-full bg-white/1 px-32 backdrop-blur-2xl'>
        ...
        <nav className='gap-x-3 flex text-lg items-center'>
            ...
            <Link to={'/signup'}><Button size={'sm'} className='bg-muted text-foreground rounded-2xl hover:bg-[#949494] cursor-pointer'>Signup</Button></Link>
              ...
              <>
               <Link to={'/'} className='text-[#949494] text-sm'>Hello, {user.email}</Link>
               <Link to={'/signup'}><Button size={'sm'} className='bg-muted text-foreground rounded-2xl hover:bg-[#949494] cursor-pointer' onClick={logout}>Logout</Button></Link>
              </>
            }
        </nav>
    </div>
